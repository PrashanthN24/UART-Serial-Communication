...
REM
REM Generated by Vivado on Fri Jun 19 23:51:00 +0530 2026
...
echo "xvlog --incr --relax -prj Baudrate_gen_vlog.prj"
call xvlog  --incr --relax -prj Baudrate_gen_vlog.prj -log xvlog.log
